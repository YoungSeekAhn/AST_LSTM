...
class DSConfig:
    ...
    # 저장 경로
    dataset_dir: str = "./TR_LSTM/_datasets"  # 데이터셋 저장 디렉토리
    getdata_dir: str = "./TR_LSTM/_csvdata"
    model_dir: str = "./TR_LSTM/_models"  # 모델 저장 디렉토리

    output_dir: str = "./TR_LSTM/_outputs"  # 출력 결과 저장 디렉토리
